<?php
/**
 * Plugin Name: WebP Express (Edited)
 * Plugin URI: https://github.com/dev-hedgehog/webp-express.git
 * Description: Генерация и вставка webp на сайте. Плагин имеет кастомный код, обновлять только с мерджем форка!
 * Version: 0.20.1
 * Author: Bjørn Rosell
